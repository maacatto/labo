...
setwd("G:\\My Drive\\Facultad\\Maestria DM\\Expecializacion\\DMEyF\\Carpetas" )  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
modelo_original <- rpart(
    ...
    xval= 0,
    cp= -1,
    minsplit= 200, # dejo que crezca y corte todo lo que quiera
    minbucket= 100,
    maxdepth= 8 )

pdf(file = "./exp/arbol_md5_mb200.pdf", width=28, height=4)
...
pdf(file = "./exp/stopping_at_canaritos.pdf", width=28, height=4)
