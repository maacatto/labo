...
{
  nrows <- length(dataset_fe[ foto_mes == 202103 & get(campo) >=0,get(campo)])
  dataset_fe <- dataset_fe[ foto_mes == 202103 & get(campo) >=0, paste0("n_", campo,"_rnk_gz") := (frank(get(campo)) -1) / (nrows-1)]
  nrows <- length(dataset_fe[ foto_mes == 202103 & get(campo) <0,get(campo)])
  dataset_fe <- dataset_fe[ foto_mes == 202103 & get(campo) <0, paste0("n_", campo,"_rnk_lz") := (frank(-get(campo)) -1) / (nrows-1)]
  
  nrows <- length(dataset_fe[ foto_mes == 202105 & get(campo) >=0,get(campo)])
  dataset_fe <- dataset_fe[ foto_mes == 202105 & get(campo) >=0, paste0("n_", campo,"_rnk_gz") := (frank(get(campo)) -1) / (nrows-1)]
  nrows <- length(dataset_fe[ foto_mes == 202105 & get(campo) <0,get(campo)])
  dataset_fe <- dataset_fe[ foto_mes == 202105 & get(campo) <0, paste0("n_", campo,"_rnk_lz") := (frank(-get(campo)) -1) / (nrows-1)]
  
  dataset_fe <- dataset_fe[ foto_mes == 202103 , paste0("n_", campo,"_rnk") :=  rowSums( cbind( get(paste0("n_", campo,"_rnk_gz")),   - get(paste0("n_", campo,"_rnk_lz"))) , na.rm=TRUE )  ]
  dataset_fe <- dataset_fe[ foto_mes == 202105 , paste0("n_", campo,"_rnk") :=  rowSums( cbind( get(paste0("n_", campo,"_rnk_gz")),   - get(paste0("n_", campo,"_rnk_lz"))) , na.rm=TRUE )  ]
  #elimina columnas 
